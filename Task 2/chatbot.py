...
intents = json.load(open('Task 2\intents.json','r'))

words = pickle.load(open('Task 2\words.pkl','rb'))
classes = pickle.load(open('Task 2\classes.pkl','rb'))
model = load_model('Task 2\chatbot_model.h5')
